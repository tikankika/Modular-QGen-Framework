#COSEAQ QE - QUIZ Questions Evaluation (Beta)
...
# Step 1: Upload Quiz Questions
 Say <UpLoad the generated quiz questions from the file (.xlsx). This includes the correct answer and the three incorrect answers for each question.
