...
- [ ] Teacher approves all questions for BB5
...
4. Approve question set for quality assurance (BB5)
5. WAIT for explicit instruction to proceed to BB5

**Teacher must explicitly say:** "Proceed to Building Block 5" or "Start quality assurance"

**DO NOT proceed automatically to BB5.**
