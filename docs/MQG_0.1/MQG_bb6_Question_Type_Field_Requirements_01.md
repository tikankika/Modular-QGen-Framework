...
## TYPE 4: FILL IN THE BLANK (SINGLE)
...
### Rules
- ⚠️ Blank indicated by: _____ (five underscores)
...
### Rules
- ⚠️ Blanks indicated by: {{BLANK-1}}, {{BLANK-2}}, etc.
...
| Type | Header | Question Text | Type-Specific | Answer | Feedback | Separator |
|------|--------|---------------|---------------|--------|----------|-----------|
| **Multiple Choice Single** | âœ… | âœ… | Options | âœ… | âœ… | âœ… |
| **Multiple Response** | âœ… | âœ… | Prompt, Options, Scoring | âœ… | âœ… | âœ… |
| **True/False** | âœ… | âœ… | Options (A/B only) | âœ… | âœ… | âœ… |
| **Fill in Blank** | âœ… | âœ… | Correct Answer, Alternatives, Case, Length | - | âœ… | âœ… |
| **Text Entry** | âœ… | âœ… | Blanks (×N), Scoring | - | âœ… | âœ… |
| **Inline Choice** | âœ… | âœ… | Dropdowns (×N), Scoring | - | âœ… | âœ… |
| **Match** | âœ… | âœ… | Premises, Choices, Scoring | âœ… | âœ… | âœ… |
| **Hotspot** | âœ… | âœ… (+ image) | Hotspot Definition | - | âœ… | âœ… |
| **Gap Match** | âœ… | âœ… | Draggables, Gaps (×N), Scoring | - | âœ… | âœ… |
| **Graphic Gap Match** | âœ… | âœ… (+ image) | Draggables, Zones (×N), Scoring | - | âœ… | âœ… |
| **Text Entry Graphic** | âœ… | âœ… (+ image) | Entry Zones (×N), Scoring | - | âœ… | âœ… |
...
| **Composite Editor** | âœ… | âœ… | Sub-Questions (×N), Scoring | - | âœ… | âœ… |
